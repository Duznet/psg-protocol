...
* После столкновение с вертикальной/горизонтальной стенкой, координаты игрока должны измениться так, чтобы расстояние
 (по х/y соответственно) от центра квадрата игрока до центра стенки было равно единице.
* Если произошло столкновение игрока со стенкой по какой-либо оси, необходимо обработать движение по другой оси в течение одного тика.
* Если произошло столкновение верхних углов квадрата игрока и нижних углов стенки, считается, что произошло столкновение со стеной по обеим осям. При аналогичном столкновении нижних углов, считается, что столкновение произошло только по оси y.
...
* Рассчет скорости по х во время падения/прыжка происходит аналогично рассчету скорости на опоре, за исключением изменения констант - удвоенное трение, уменьшенное вдвое ускорение.
...
* players => массив объектов, описывающих каждого игрока. В порядке подключения к игре
    ...
    - respawn => число, время в тиках до респауна игрока. В случае, если status == "alive", поле не требуется
* projectiles => массив объектов, описывающих снаряды
    ...
    - owner => строка, логин игрока, который сделал выстрел
