...
* projectiles => массив **массивов**, описывающих снаряды. Один снаряд описывается в следующем порядке:
    ...
    - lifeTime => целое число, "время жизни" снаряда, при первом появлении снаряда должно быть равно 1. Далее на каждом тике это значение увеличивается на 1
...
##### Пример сообщения от сервера

    {
        ...
        "projectiles": [
            [12.12, 10.6, -0.6, 0.1, "M", 1],
            [10.14, 11.22, -0.6, 0.1, "M", 2]
        ]
    }
