...
### Тики
* Игровой тик - 30 мс
* В первом сообщении отправляемом с сервера, после создания игры tick: 1
* Текущим тиком игры называется число, которое будет отправлено в ближайшайшем сообщении сервера
* Если на сервер пришло сообещние от клиента, в котором тик не равен текущему, данное сообщение игнорируется. 
